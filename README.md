...
> - **DashScope provider split**: `dashscope` is only for the standard BaiLian compatible-mode endpoint. `dashscopeCodingPlan` is only for the Coding Plan endpoint `https://coding.dashscope.aliyuncs.com/v1`. Nanobot does not auto-switch between them based on `apiBase`. For international Coding Plan access, override `"apiBase": "https://coding-intl.dashscope.aliyuncs.com/v1"` under `dashscopeCodingPlan`.
...
| `dashscope` | LLM (Qwen, BaiLian compatible-mode) | [dashscope.console.aliyun.com](https://dashscope.console.aliyun.com) |
| `dashscopeCodingPlan` | LLM (Qwen Coding Plan) | [dashscope.console.aliyun.com](https://dashscope.console.aliyun.com) |
